...
public class Test_video {
    ...
    public static void main(String[] args) throws InterruptedException {
      ...
      //return email.matches(regex);
        ...
        driver.get("file:///C:/Users/DILIP/Desktop/web/videoboot.html");
       ...
       // WebDriver d=new ChromeDriver();
        ...
        driver.navigate().back();
        driver.findElement(By.id("regi")).click();
        driver.findElement(By.id("uid")).sendKeys("ram");
        driver.findElement(By.id("pwd")).sendKeys("4567");
        driver.findElement(By.id("aa")).sendKeys("shubham@gmail.com");
        driver.findElement(By.id("phno")).sendKeys("794034930");
        Thread.sleep(2000);
